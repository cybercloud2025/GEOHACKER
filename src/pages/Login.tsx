...
export const LoginPage = () => {
    ...
    // Estado de Inicio de Sesión Secreto
    ...
    return (
        <div className="flex flex-col items-center justify-start sm:justify-center min-h-screen px-4 pt-36 sm:pt-0 relative overflow-hidden bg-black font-sans selection:bg-cyan-500/30 selection:text-cyan-200">
            ...
            >
                {/* Contenedor de Tarjeta de Cristal */}
                <div className="relative group">
                    {/* Gradiente de Brillo de Borde - EFECTO DE PARPADEO ALEATORIO */}
                    ...
                    <div className="relative bg-black/80 backdrop-blur-xl md:backdrop-blur-2xl rounded-3xl border-4 border-white/20 shadow-[0_0_50px_rgba(0,0,0,0.9)] overflow-hidden">
                        ...
                        {/* Decoración de Cabecera de Tarjeta */}
                        ...
                        <div className="p-8 pt-10 space-y-6">
                            ...
                            <div className="flex flex-col items-center justify-center space-y-4">
                                ...
                                <div className="text-center space-y-2 relative">
                                    <h2 className={`text-5xl font-black tracking-[0.25em] relative inline-block transition-all duration-300 ${triggerGlitch ? 'glitch-text ring-2 ring-cyan-500/20' : ''}`}>
                                        <span className="animate-text-tech bg-clip-text drop-shadow-[0_0_15px_rgba(0,247,255,0.5)]">
                                            {isRegistering ? 'NUEVO AGENTE' : 'GEO HACKER'}
                                        </span>
                                    </h2>
                                    <div className="flex items-center justify-center gap-2">
                                        <div className="h-px w-8 bg-gradient-to-r from-transparent to-green-500/50" />
                                        <p className="text-[12px] text-green-400 tracking-[0.5em] uppercase font-black drop-shadow-[0_0_10px_rgba(34,197,94,0.6)] animate-pulse">
                                            {isRegistering ? 'INICIANDO PROTOCOLO' : 'SISTEMA OPERATIVO'}
                                        </p>
                                            ...
                                            <Input
                                                ...
                                                className={`relative z-10 text-center font-mono text-2xl tracking-[0.5em] h-16 rounded-2xl border-4 transition-all duration-300
                                                    ${error
                                                        ...
                                                        : 'bg-black/60 border-red-600 text-red-500 focus:border-red-500 focus:shadow-[0_0_30px_rgba(239,68,68,0.2)]'
                                                    }
                                                `}
                                                maxLength={6}
                                                value={formData.pin}
                                                onChange={(e) => {
                                                    ...
                                                    if (rawValue.startsWith('@')) {
                                                        // Regla de Admin: @ + 5 dígitos
                                                        cleaned = '@' + rawValue.slice(1).replace(/\D/g, '').slice(0, 5);
                                                    } else {
                                                        // Regla de Usuario: 4 dígitos
